...
`ifdef FUNCTIONAL
`include "sky130_fd_sc_lp__busdrivernovlpsleep_20.functional.pp.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_lp__busdrivernovlpsleep_20.timing.pp.v"
`endif // FUNCTIONAL

`else  // USE_POWER_PINS

`ifdef FUNCTIONAL
`include "sky130_fd_sc_lp__busdrivernovlpsleep_20.functional.v"
`else  // FUNCTIONAL
`include "sky130_fd_sc_lp__busdrivernovlpsleep_20.timing.v"
`endif // FUNCTIONAL
